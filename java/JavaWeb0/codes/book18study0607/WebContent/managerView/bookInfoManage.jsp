			...
			<tr>
				...
				<td width=80% align=center>
					...
					<table>
						...
						<tr>
							<td colspan="8" bgcolor="#008B8B" width="100%" height="5"
								colspan="3"></td>
						</tr>
						<tr>
							<td colspan="8" height="30" align="right"><a
								href="addBook.jsp">新增图书</a></td>
						</tr>
						...
						<tr>
							...
							<td><a target="_blank"
								href="<%=request.getContextPath()%>/userView/bookInfo.jsp?bookId=<%=book.getId()%>">
									查看</a></td>
							<td><a href="modifyBook.jsp?bookId=<%=book.getId()%>">修改</a>
							</td>
							<td><a
