				...
				<td width=80% align=center>
					<form action="<%=service %>/UserManage.action" method="post">
						...
						<table>
							...
							<tr>
								<td height="30" align="right" colspan="6"><a
									href="managerView/user/addUser.jsp">新增用户</a></td>
							</tr>
							<tr>
								<td width=50>选择</td>
								<td width=80>用户姓名</td>
						...
						%>
							<tr>
								...
								<td><%=user.getSex() %></td>
								<td><a
									href="managerView/user/modifyUser.jsp?userId=<%=user.getId()%>">修改</a></td>
								<td><a
									href="<%=service %>/UserManage.action?doType=deleteUser&userId=<%=user.getId()%>">删除</a>
								</td>
							</tr>
							<%
							}
						%>
							<tr>
								<td height="30" align="left" colspan="6"><input
