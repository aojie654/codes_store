						...
						<table>
							...
							<tr>
								...
								<td width=105><input name="name" type="text"
									onblur="return isName(this.value)"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>真实姓名:</td>
								<td width=105><input name="realName" type="text"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>手机号码:</td>
								<td width=105><input name="phone" type="text"
									onblur="return isPhone(this.value)"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>邮箱地址:</td>
								<td width=105><input name="email" type="text"
									onblur="return isEmail(this.value)"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>联系地址:</td>
								<td width=105><input name="address" type="text"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>年龄:</td>
								<td width=105><input name="age" type="text"
									onblur="return isAge(this.value)"></td>
								<td style="color: red">*</td>
							</tr>
							<tr>
								<td width=105>性别:</td>
								<td width=105>男：<input name="sex" type="radio" value="1"
									checked="checked"> 女：<input name="sex" type="radio"
									value="0">
								</td>
								<td style="color: red">*</td>
							</tr>
