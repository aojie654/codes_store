<%@ page language="java" import="bean.*,service.*"
	pageEncoding="UTF-8"%>
...
<body>
	...
	<form name="buy" onSubmit="return checkNum(number.value)"
		action="<%=request.getContextPath()%>/servlet/Customer?requestType=changeCart" method="post">
		...
		<table  width="600" align="center">
			...
			<tr>
				...
				<td width="150">
				<input type="text" value="<%=cartBookNum%>" size=1	name="number" onblur="sum();">本</td>
