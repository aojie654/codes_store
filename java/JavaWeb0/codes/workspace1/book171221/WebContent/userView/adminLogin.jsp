...
<body>
	<center>
		...
		<form action="<%=request.getContextPath() %>/servlet/Index?requestType=adminLogin"
			method="post" name="ad">
			...
			<tr>
				<td  align="right"   height="30px" ><input type="submit" value="登陆"></td>
				<td  align="center" ><input type="reset" value="取消"></td>
				<td><a href="/BookStore/index.jsp" class="common">返回首页</a></td>
			</tr>
			<tr height="20px"></tr>
				<tr bgcolor="#008B8B">
					<td colspan="3" align="center"><small>友情提示:管理员用户名和密码均为<font	color="#FF0000">admin</font></small></td>
				</tr>
			</table>
		</form>
		<br>
