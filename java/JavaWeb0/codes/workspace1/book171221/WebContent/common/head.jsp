...
a.menu:link {color:#FFFFFF;}	/* 未被访问的链接 */
a.menu:visited {color:#FFFFFF;}	/* 已被访问的链接 */
a.menu:hover {color:#66CDAA;}

a.common:link {color:#000000;}	/* 未被访问的链接 */
a.common:visited {color:#000000;}	/* 已被访问的链接 */
a.common:hover {color:#008B8B;}
