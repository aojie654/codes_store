				...
				<td width=80% align=center>
					<table >
						...
						<tr>
							...
							<td><%=bc.getName() %></td>
							<td><a
								href="modifyCategory.jsp?categoryId=<%=bc.getId()%>&categoryName=<%=java.net.URLEncoder.encode(bc.getName(),"utf-8")%>">修改</a></td>
							<td>
							<a href="<%=request.getContextPath()%>/servlet/Admin?requestType=delete&categoryId=<%=bc.getId()%>">删除</a>
							</td>
						</tr>
